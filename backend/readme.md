# Backend JSON Server
librairie utilisé : https://github.com/typicode/json-server
...
## Deployment
You can deploy JSON Server. For example, http://jsonplaceholder.typicode.com/ JSONPlaceholder is an online fake API powered by JSON Server and running on Heroku.